 ...
 */
final class Version20240428183431 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_product_product (cart_product_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_7BE599ED4584665A (product_id), INDEX IDX_7BE599ED25EE16A8 (cart_product_id), PRIMARY KEY(cart_product_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
